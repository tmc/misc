...
These blocks maintain their syntax highlighting and can be rendered properly
by Markdown viewers that support these features (like GitHub or specialized
tools like md2html).
